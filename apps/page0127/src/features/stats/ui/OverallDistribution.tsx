...
// 평점 숫자 → 라벨. isLifeBook 이 참이면 "인생책"이고, 0도 점수가 아니라 "평가 안 함"이다.
// (인생책만 이름으로 부르고 0을 `0점`으로 두면 척도가 반쪽만 고쳐진다)
