        ...
        <Card className='mb-6 shadow-none'>
          ...
          <CardContent>
            <div className='mb-4 rounded-lg bg-chart-2/10 p-4'>
              <p className='text-center text-xl font-bold text-chart-2'>{personality_type}</p>
            </div>
          ...
          <CardContent className='space-y-6'>
            ...
            <div>
              ...
              <div className='space-y-2'>
                ...
                <div>
                  <p className='text-sm font-medium text-muted-foreground'>스타일</p>
                  <div className='flex flex-wrap gap-2 mt-1'>
                ...
                <div>
                  <p className='text-sm font-medium text-muted-foreground'>구조</p>
                  <div className='flex flex-wrap gap-2 mt-1'>
            ...
            {/* 피하는 것 */}
            <div>
              <h3 className='mb-3 font-semibold text-destructive'>💔 피하는 것</h3>
              <div className='space-y-2'>
                <div>
                  <p className='text-sm font-medium text-muted-foreground'>주제</p>
                  <div className='flex flex-wrap gap-2 mt-1'>
              ...
              <div key={book.id} className='rounded-lg border border-border bg-card p-4'>
                <div className='flex gap-4'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='mt-2 text-sm text-foreground'>{book.reason}</p>
                  </div>
                </div>
              </div>
            ))
          ) : (
            <p className='text-center text-muted-foreground py-4'>추천 도서가 없습니다.</p>
          )}
        </div>
      </CardContent>
    </Card>
