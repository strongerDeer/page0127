  ...
  return (
    <form action='/books/all' role='search' className='relative w-full'>
      ...
      <input
        ...
        aria-label='도서 검색'
        className='h-9 w-full rounded-full border border-line bg-sunken pl-9 pr-4 text-sm text-text-strong placeholder:text-text-subtle focus:border-transparent focus:bg-card focus:outline-none focus:ring-2 focus:ring-ring/50'
      />
    </form>
  );
};
